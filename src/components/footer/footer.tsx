import { Icons } from "../main-page/icons";
...
//   },
  ...
  //   items: [
  //     {
  //       href: "https://docs.numexa.io/",
  //       name: "Docs",
  //     },
  //     {
  //       href: "https://github.com/dillionverma/Numexa/issues",
  //       name: "Feedback and Requests",
  //     },
  //     {
  //       href: "https://github.com/dillionverma/numexa/commits/main",
  //       name: "Changelog",
  //     },
  //   ],
  // },
  {
    ...
    items: [
      {
        href: "https://discord.gg/3PeyEhQw",
        name: "Discord",
      },
      {
